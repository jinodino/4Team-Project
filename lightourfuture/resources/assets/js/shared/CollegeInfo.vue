<template>
  <v-container  v-if="info != null" fluid grid-list-xs>
    <v-flex >
        <h4 class="Titlefont">基本情報</h4>
        <!-- <h4>기본 정보</h4> -->
        <hr style="width:150px; border: 1px solid #008080">
    </v-flex>
    <v-flex>
      <v-layout row>
        ...
        <v-flex xs12 md3 lg3 color="white">
          <v-card>
            ...
            <!-- <img style="height :  219px; width : auto" :src="info.collegeInfo.photo_url" > -->
          </v-card>
        </v-flex>
        ...
        <v-flex xs12 md5 lg5  >
          ...
          <v-layout>
            ...
            <v-flex> : 
              ...
              <!-- {{info.collegeInfo.college_category === 'c' ? "전문대" : "일반대"}} -->
            </v-flex>
          </v-layout>
          <v-layout>
            <v-flex xs3 md3 lg3 >
            ...
            <v-layout>
              ...
              <v-flex> :  
                {{info.collegeInfo.homepage_url !== null ? info.collegeInfo.homepage_url : "─"}}
              </v-flex>
            </v-layout>
          </v-card-text>
        </v-flex>
    ...
    <v-flex style="margin-top: 15px">
      <v-layout>
      <h4 class="Titlefont" style="color:secondary; margin-top: 60px">
        学科情報
        <!-- 학과 정보 -->
      <hr style="width:150px; border: 1px solid #008080">
      </h4>
    ...
    <hr style="width:150px; border: 1px solid #008080">
      ...
      <!-- 채용건 리스트 -->
      <b-table responsive :fields="statistics_headers" :items="info.facultyInfo.employment_list" item-key="faculty_id">
        <template slot="num" slot-scope="data">
          <p>{{++data.index}}</p>
        </template>
