<template>
    <v-app style="background : linear-gradient(to right, rgb(35, 206, 156)  , rgb(17,80,206) 90% );">
        ...
        <v-flex style="margin:80px 0 0 0; background-image:url('/images/Index/backgroundPattern.png'); background-size: 100% auto;">
            
            <p style="margin:20px 0 -125px 0; font-size:70px; color: rgb(0,112, 240); text-align: center;" class="hidden-xs-only"><b>希望が生まれるシカケをつくる</b></p>
                    ...
                    <v-container fluid grid-list-xl>
                        <v-layout row wrap justify-center>
                            <v-flex xs12 sm6 md3 lg3>
                                ...
                                <v-card hover flat @click="redirectLogin('student')" style="border-top : 7px solid rgb(0,112, 240)">
                            ...
                            <v-flex xs12 sm6 md3 lg3>
                                <div style="margin:200px 0 0 0" class="hidden-xs-only"></div>
                                <v-card hover flat @click="redirectLogin('professor')" style="border-top : 7px solid rgb(0,112, 240)">
                            ...
                            <v-flex xs12 sm6 md3 lg3>
                                <div style="margin:200px 0 0 0" class="hidden-xs-only hidden-sm-and-down"></div>
                                <v-card hover flat @click="redirectLogin('company')" style="border-top : 7px solid rgb(0,112, 240)">
                            ...
                            <v-flex xs12 sm6 md3 lg3>
                                <div style="margin:200px 0 0 0" class="hidden-xs-only hidden-sm-and-down"></div>
                                <v-card hover flat @click="redirectLogin('agent')" style="border-top : 7px solid rgb(0,112, 240)">
            ...
            <!-- <v-flex style="margin-top:-150px; height: 200px; background : linear-gradient(to right, rgb(35, 206, 156)  , rgb(17,80,206) 90% );" class=" hidden-sm-and-up"></v-flex> -->
            <v-flex style="margin-top:-120px; height: 210px; background : linear-gradient(to right, rgb(35, 206, 156)  , rgb(17,80,206) 90% );" class="hidden-xs-only"></v-flex>
        </v-flex>
        <!-- <v-footer height="30%" style="background : linear-gradient(to right, rgb(35, 206, 156)  , rgb(17,80,206) 90% );">
        </v-footer> -->
