    ...
    <v-tabs
      ...
      <v-tabs-items v-model="tab">
          <v-tab-item v-for="org_agent in user.affiliation" :key="org_agent.no.key">
            <agent-std-manage-item v-if="skillListInfo != null" 
            :orgAgent="org_agent" 
            :classification="user.classification"
            :skillListInfo="skillListInfo"
            ></agent-std-manage-item>
          </v-tab-item>
      </v-tabs-items>
    </v-container>
</template>
...
<script>
import AgentStdManageItem from "./AgentStdManageItem";
export default {
  components : {
    'agent-std-manage-item' : AgentStdManageItem,
  },
